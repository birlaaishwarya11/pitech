...
class Settings(BaseSettings):
    ...
    # OpenRouteService
    # Self-hosted (docker-compose): ORS_BASE_URL=http://localhost:8080/ors, no key needed
    # Public API fallback: ORS_BASE_URL=https://api.openrouteservice.org, key required
